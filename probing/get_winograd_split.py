"""
Utility file to convert from the various sources to the binary source we want.
...
def build_spans_aligned_with_tokenization(text1, pronoun, context, text2, names):
    ...
    import math
    import re
    total_text = text1 + " "+ context+" "+ text2
...
def convert_to_json():
    ...
    for link in [ "test_final.tsv", "train_final.tsv", "val_final.tsv"]:
        tokenizer_name = "bert-base-cased"
