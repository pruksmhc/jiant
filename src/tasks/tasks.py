...
class GapCoreferenceTask(Task):
    ''' 
    Class for GAP Coreference
     Input is text, pronoun, and two spans (A and B spans)
    Labels are: A is coreferent, B is coreferent, or neither
    '''
    @property
    ...
    def __init__(self, path: str, max_seq_len: int,
                 ...
                 domains: List = ["FEMININE", "MASCULINE"],
        ...
        """
        super().__init__(name, **kw)
        files_by_split = {'train': "gap-development.json", 'val': "gap-validation.json",'test': "gap-test.json"}
