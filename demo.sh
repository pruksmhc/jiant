...
python main.py --config_file config/baselinesuperglue/superglue.conf  --overrides "pretrain_tasks = gap-coreference, do_pretrain = 0,  target_tasks=gap-coreference, run_name = rnn_enc, project_dir=gap, bert_embeddings_mode = top, load_model=1, load_eval_checkpoint=\"/misc/vlgscratch4/BowmanGroup/yp913/coreference/jiant/gap/base_bert_cased/rnn_enc/model_state_main_epoch_27.th\",  exp_name=base_bert_cased, sent_enc = \"rnn\", bert_model_name = bert-base-cased, ${eval_cmd}"
