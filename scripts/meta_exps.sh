...
# debug
python main_profile.py --config config/meta--overrides "exp_name = metalearn, run_name = debug-meta, max_vals = 3, val_interval = 100, do_train = 1, train_for_eval = 0, train_tasks = \"mnli,snli\", eval_tasks = \"none\", do_eval = 0, metatrain = 1, slow_params_approx = 0, sent_enc = conv, d_hid = 512, mnli_pair_attn = 1, snli_pair_attn = 1, batch_size = 32"
